...
// from https://devtribe.ru/p/unity/modules-guide
// Удаляем лишние файлы из иерархии сборок 
// Так же, вы можете заметить, что многие файлы, не имеющие отношения к вашей текущей сборке могут отображаться внутри нее - .txt, .shader, .xml 
// и прочие файлы добавляются к каждой сборке.
// Чтобы исправить это - скопируйте скрипт, написанный ниже в любую папку Editor вашего проекта. Чтобы изменения подействовали от вас так же 
// потребуется немного ручной работы: удалите все .csproj файлы в корне вашего проекта, а после выберите в Unity пункт Assets/Open C# Project. 
// Это заставит все ваши файлы сгенерироваться с дополнительными изменениями.
